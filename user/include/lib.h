...
// debugf (defined in lib/debugf.c)
...
/// syscalls (implemented in user/lib/syscall_lib.c, or inlined/macro)
...
// Prototypes for CWD management syscalls
int syscall_getcwd(char *buf, u_int len);
int syscall_chdir(const char *path);

// Shell Challenge: Prototypes for environment variable syscalls
