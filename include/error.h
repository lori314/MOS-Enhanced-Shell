...
// MODIFICATION: Path corresponds to a file, not a directory
#define E_NOT_A_DIR 14

// Shell Challenge: Variable not found
#define E_VAR_NOT_FOUND 15

// Shell Challenge: Permission denied (e.g., modifying a read-only variable)
#define E_PERM 16
